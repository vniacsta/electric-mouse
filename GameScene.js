  ...
  create() {
      ...
      if (game.input.enabled) {
        ...
        switch (randomMove) {
          case 0:
            ...
            gameState.information.text = 'Both players lost 1 HP...';
            gameState.player.sprite.anims.play('playerAttack');
            gameState.computerSprite.anims.player(gameState.computer.name + 'Attack');
            break;
          case 1:
            gameState.playerMove.text = 'Attack!';
            ...
            gameState.playerHealthBar.text = `HP: ${gameState.player.health}`;
            gameState.computerHealthBar.text = `HP: ${gameState.computer.health}`;
            gameState.information.text = 'Electric Mouse loses 1 HP...'
            gameState.player.sprite.anims.play('playerAttack');
            gameState.computerSprite.anims.player(gameState.computer.name + 'Defend');
            break;
          case 2:
            gameState.playerMove.text = 'Attack!';
            ...
            gameState.playerHealthBar.text = `HP: ${gameState.player.health}`;
            gameState.computerHealthBar.text = `HP: ${gameState.computer.health}`;
            gameState.information.text = 'Electric Mouse is unharmed and enemy loses 5 HP...'
            gameState.player.sprite.anims.play('playerAttack');
            gameState.computerSprite.anims.player(gameState.computer.name + 'Special');
            break;
        } 
      }
    });
    ...
    gameState.defendButton.on('pointerup', () => {
      ...
      if (game.input.enabled) {
        ...
        switch (randomMove) {
          case 0:
            gameState.playerMove.text = 'Defense!';
            gameState.computerMove.text = 'Attack!';
            gameState.computer.health--;
            gameState.playerHealthBar.text = `HP: ${gameState.player.health}`;
            gameState.computerHealthBar.text = `HP: ${gameState.computer.health}`;
            gameState.information.text = 'Electric Mouse is unharmed and enemy loses 1 HP...';
          ...
          case 2:
            ...
            gameState.playerHealthBar.text = `HP: ${gameState.player.health}`;
            gameState.computerHealthBar.text = `HP: ${gameState.computer.health}`;
            gameState.information.text = 'Electric Mouse lost 4 HP...'
            gameState.player.sprite.anims.play('playerDefense');
            gameState.computerSprite.anims.player(gameState.computer.name + 'Special');
            break;
        } 
